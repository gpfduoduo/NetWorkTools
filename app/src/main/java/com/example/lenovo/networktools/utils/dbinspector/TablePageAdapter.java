...
public class TablePageAdapter {
    ...
    public TablePageAdapter(Context context, File databaseFile, String tableName, int startPage) {
        ...
        paddingPx = DeviceUtils.dip2px(this.context, 5);
        ...
        String rowsPerPage = PreferenceManager.getDefaultSharedPreferences(this.context).getString(keyRowsPerPage, defaultRowsPerPage);
